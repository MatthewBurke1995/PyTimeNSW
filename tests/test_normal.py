...
class TestPyTime(unittest.TestCase):
    ...
    def test_festival(self):
        ...
        self.assertTrue(this4)
        this5 = pytime.boxing(2011) == datetime.date(2011, 12, 26)
        self.assertTrue(this5)
        this6 = pytime.mother(2010) == datetime.date(2010, 5, 9)
        self.assertTrue(this6)
        this7 = pytime.father(2017) == datetime.date(2017, 9, 3) #different from USA
        self.assertTrue(this7)
        this8 = pytime.australia(2008) == datetime.date(2008, 1, 26)
        self.assertTrue(this8)
        this9 = pytime.goodfri(2007) == datetime.date(2007, 4, 6)
        self.assertTrue(this9)
        this10 = pytime.eastersat(2007) == datetime.date(2007, 4, 7)
        self.assertTrue(this10)
        ...
        self.assertTrue(this13)
        this14 = pytime.queen(2017) == datetime.date(2017, 6, 12)
        self.assertTrue(this14)
